import { listaPedidos } from "../database/models/listaPedidos.js";
import {
  insert,
  update,
  deleteById,
...
class comandasController {
  static async getAllListaPedidos(req, res) {
  ...
  static async getListaPedidosById(req, res) {
  ...
  static async postListaPedidos(req, res) {
  ...
  static async putListaPedidos(req, res) {
  ...
  static async deleteListaPedidos(req, res) {
